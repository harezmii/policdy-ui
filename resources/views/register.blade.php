            ...
            <div
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Kayıt Ol</h1>
                            <p class="text-base font-bold leading-normal text-white-dark">Email ve sifrenizi girerek kayıt olunuz.</p>
                        </div>
                        <form class="space-y-5 dark:text-white"  method="POST" action="{{ route('registerPost') }}">
                            @csrf
                            <div>
                            ...
                            <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]"> Sign Up </button>
                        </form>
                        ...
                        <div class="text-center dark:text-white"> Already have an account ? <a href="/login" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN IN</a>
                        </div>
                    </div>
                </div>
            </div>
